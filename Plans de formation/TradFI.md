...
1. Indices & ETF (tokenisation TradFi)
  
1. Fixed Income (fondation temporelle)
  
1. Taux, ZC, discounting → Pendle bridge
  
1. Repo & lending (collatéralisation TradFi)
  
1. Futures, perps & arbitrages delta-neutral
  
1. Market making & microstructure
  
1. Options (payoffs → structuration)
  
1. Portefeuille & allocation (Markowitz → vault design)
  
1. Produits structurés & ingénierie financière
  
1. Risk management & stress
  
1. Synthèse TradFi ↔ DeFi
...
- Mouvement brownien — la limite continue dune marche aléatoire
...
- Mouvement brownien → VRF Chainlink pour laléa vérifiable
